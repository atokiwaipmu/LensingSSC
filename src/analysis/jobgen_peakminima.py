...
#PBS -N PeaksMinima_{config}_{redshift}
#PBS -o {log_dir}/PeaksMinima_{config}_{redshift}.out
#PBS -e {log_dir}/PeaksMinima_{config}_{redshift}.err
...
"""
    ...
    script_filename = os.path.join(script_dir, f'job_script_{redshift}.sh')
    with open(script_filename, 'w') as file:
        file.write(job_script)
    
    print(f"Generated job script for redshift {redshift}: {script_filename}")
